...
import LogoSpugText from 'layout/gh-logo-spug-white.png';
                ...
                <Menu onClick={({key, domEvent}) => handeTabAction(key, host, domEvent)}>
                    ...
                    <Menu.Item key="rClose"
                               icon={<VerticalAlignBottomOutlined
                                   style={{transform: 'rotate(90deg)'}}/>}>关闭右侧</Menu.Item>
                    <Menu.Item key="oClose"
                               icon={<VerticalAlignMiddleOutlined
                                   style={{transform: 'rotate(90deg)'}}/>}>关闭其他</Menu.Item>
        ...
        <div className={styles.container} onMouseUp={() => posX = 0} onMouseMove={handleMouseMove}>
            <div className={styles.sider} style={{width}}>
                <a className={styles.logo} href="/host" target="_blank">
                    <img src={LogoSpugText} alt="logo11"/>
                </a>
            ...
            <div className={styles.content}>
                ...
                {hosts.length === 0 && (
                    <pre className={sshMode ? styles.fig : styles.fig2}>{gh_web_terminal}</pre>
                )}
            </div>
            <Drawer
                title="文件管理器"
